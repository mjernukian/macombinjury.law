...
ES = {
    ...
    "pairs": [
        ...
        ('<h2 class="rv">Car, truck, motorcycle and pedestrian cases.</h2>', '<h2 class="rv">Casos de auto, camión, moto y peatones.</h2>'),
...
AR = {
    ...
    "pairs": [
        ...
        ('<h2 class="rv">Car, truck, motorcycle and pedestrian cases.</h2>', '<h2 class="rv">قضايا السيارات والشاحنات والدراجات النارية والمشاة.</h2>'),
        ('<p class="rv">Michael represents people hurt in collisions throughout Macomb County, including Sterling Heights, Warren, Clinton Township, Shelby Township, Macomb Township, St. Clair Shores, Roseville and Mount Clemens, and across Michigan.</p>',
